...
[3D модель](https://www.thingiverse.com/thing:7319866)

[Плейлист на youtube с описанием, демонстрацией и сборкой](https://youtube.com/playlist?list=PLLB8YXu4D8PunXm6wkRArw5l53CUL2j-Z&si=r77Fl3qdb0qFjc_D)
...
### Общие советы при замерах

1. Работайте с приглушенным или выколюченным красным светом
2. Уберите телефон подальше. Он может излучать ИК свет (Лидар, FaceID)
3. Контролируйте угол измеряемого света. Используйте для этого прицел из оргстекла
...
2. Нажмите на боковую кнопку чтобы начать считать значения относительно него
3. найдите теперь самый светлый/темный участок
4. Полученное значение -- контраст негатива в logD
...
2. **Тактовая кнопка 12x12x9мм**. Высота может быть и другой -- под нее нужно будет просто подобрать крышку
...
5. **Мультиплексор 74HC4067**. Используется для переключения усиливающих резисторов на фотодиоде
6. **16 битный АЦП ADS1115**. Используется для считывания значений с фотодиода
...
4. **Синий пластикоывй светофильтр 1.5мм**. Можно взять и зеленый -- его цель отфильтровывать часть красного света
5. **Полупрозрачный акрил**. Для стиля и затенения экрана
...
1. Не перегревайте фотодиод во время пайки. Он может сломаться. Давайте время ему остыть
...
5. После сборки устройства убедитесь, что у вас никакие компоненты не светят. Вы можете выломать светящиеся диоды
6. Проверьте потребляемый ток идущий из батареи -- он должен быть в районе 0.3мA, когда устройство спит
